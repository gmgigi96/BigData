...
TIME=/bin/time
JAR_MR=/home/gianmaria/Documenti/Proj/BigData/out/artifacts/BigDataMR/BigDataMR.jar
...
for file in `hdfs dfs -ls -C /input/hsp*`; do
    ...
    $TIME -f "$LINES\t%e" -a -o MRBenchmarks/job3.txt hadoop jar $JAR_MR proj/mapreduce/job3/$MAIN_CLASS_JOB3 "/temp_mr/job2_1_$LINES" $HISTORICAL_STOCKS_DATASET "/temp_mr/job3_1_$LINES" "/temp_mr/job3_2_$LINES" "/output_mr/job3_mr_$LINES"
